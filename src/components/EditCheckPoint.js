...
const CreateCheckPoint = ({ checklisttype, modify_checlist, setOpen3,editcheckpointinfo,edit_checklist }) => {
  ...
  console.log('editcheckpointinfo',editcheckpointinfo)
  ...
  const [problemnotifications, setproblemnotifications] = useState(editcheckpointinfo?.details?.problemnotifications);
  ...
  const [checkName, setcheckName] = useState(editcheckpointinfo.details?.checkName);
  const [checkDesc, setcheckDesc] = useState(editcheckpointinfo.details?.checkDesc);
  ...
  return (
    <div className="create-checkpoint flex flex-col">
      <div className="checkpoint-hdr flex flex-col aic">
        <div className="heading s14 font b6">Edit CheckPoint</div>
      ...
      <div className="btns-action flex aic">
        ...
        <button
          onClick={() => {
            edit_checklist(editcheckpointinfo?.details?.maintainedBy, checkName, checkDesc, startDate,problemnotifications,editcheckpointinfo.index);
            setOpen3(false);
          }}
