  ...
  const editrfid = async (id) => {
    ...
    try {
      let res2 = await axios.post(
        `${process.env.REACT_APP_END_URL}api/editrfid`,
        formData,
        config
      );
      console.log(res2);
  ...
  return (
    <div className="add-new-rfid flex flex-col">
      <div className="asd-header flex aic jc">
        <div className="lbl s16 b6 font">Edit RFID</div>
      </div>
      <div className="user-info flex">
        ...
        <div className="info-right flex flex-col">
          ...
          <div className="txt-field flex flex-col">
            <div className="lbl s12 font">Edit/Scan RFID</div>
            <div className="txt-box flex aic">
              <input
                type="text"
                value={rfid2}
                className="txt cleanbtn s12 font"
                placeholder="Edit the ID or scan the RFID"
