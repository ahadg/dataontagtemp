      ...
      <div className="check-points-meta flex flex-col">
        <div className="check-points-item flex aic">
          ...
          <div className="right flex aic jc">
           {selectedcontrolpoint.controlpoint.controlpointname}
          </div>
        </div>
        <div className="check-points-item flex aic">
          <div className="left flex">Control point description :</div>
          <div className="right flex"> {selectedcontrolpoint.controlpoint.controlpointname}</div>
        </div>
        <div className="check-points-item flex aic">
        ...
        <div className="check-points-item flex aic">
          ...
          <div className="right flex">ExtSup s.r.l.</div>
          {/* <div className="right flex">{selectedcontrolpoint.controlpoint?.createdBy?.companyName}</div> */}
        </div>
        <div className="check-points-item flex aic">
          <div className="left flex">Company Address :</div>
          <div className="right flex">Piazza Statuto 1, Torino</div>
          {/* <div className="right flex">{selectedcontrolpoint.controlpoint?.createdBy?.companyAddress}</div> */}
        </div>
        <div className="check-points-item flex aic">
          <div className="left flex">Inspector :</div>
          <div className="right flex">Domenico Grosso</div>
          {/* <div className="right flex">{selectedcontrolpoint?.checkedby?.userName}</div> */}
        </div>
        <div className="check-points-item flex aic">
        ...
        <div className="check-points-item flex aic">
          ...
          <div className="right flex">{theinspection?.location
                            ?.location}</div>
        </div>
        <div className="check-points-item flex aic">
        ...
        <div className="check-points-item flex aic">
          ...
          <div className="right flex ">{`${moment(Number(theinspection.manufacturingdate)).format("D")}-${moment(
                          Number(theinspection.manufacturingdate)
                        ).format("MM")}-${moment(Number(theinspection.manufacturingdate)).format(
                          "YYYY"
                        )}`}</div>
        </div>
        <div className="check-points-item flex aic">
